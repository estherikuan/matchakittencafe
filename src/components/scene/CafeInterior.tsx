      ...
      <section className="relative mx-auto flex min-h-screen max-w-[1400px] flex-col items-center justify-center px-1 py-2 pb-32 sm:px-2 sm:py-8 sm:pb-32 lg:px-4 lg:py-12 lg:pb-36 portrait:justify-start portrait:pt-3 portrait:pb-32">
        ...
        >
          ...
          <div className="relative portrait:h-full portrait:w-full landscape:scale-100">
            ...
            >
              {[0, 1, 2].map((i) => (
                <motion.span
                  ...
                  style={{
                    background: "radial-gradient(circle, oklch(1 0 0 / 0.55) 0%, oklch(1 0 0 / 0) 70%)",
                    filter: "blur(2px)",
                  }}
                  animate={{
                    y: [0, -60, -120],
            ...
            <div
              className="absolute grid gap-2 text-left overflow-hidden left-[6%] top-[12%] w-[36%] h-[30%] md:left-[7%] md:top-[10%] md:w-[55%] md:h-[32%] portrait:!left-[6%] portrait:!top-[9%] portrait:!w-[81%] portrait:!h-[26%]"
                ...
                <div className="mt-5 flex justify-center">
                  ...
                  <div className="relative h-40 w-40">
                    <div
                      ...
                      style={{
                        background: "radial-gradient(circle at 40% 35%, oklch(0.86 0.09 145), oklch(0.72 0.11 140))",

...
export function CafeExterior({ onEnter }: Props) {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <section className="relative mx-auto flex min-h-screen max-w-[1400px] flex-col items-center justify-center px-1 py-8 pb-32 sm:px-2 sm:py-10 sm:pb-32 lg:px-4 lg:py-16 lg:pb-36 portrait:justify-start portrait:pt-20 portrait:pb-32">
        <motion.div
        ...
        <motion.div
          ...
          className="relative mx-auto mt-28 w-full max-w-[980px] md:mt-32 lg:mt-36 xl:mt-16 portrait:mt-16 portrait:flex portrait:h-[60vh] portrait:w-auto portrait:max-w-none portrait:items-center portrait:justify-center sm:portrait:block sm:portrait:h-auto sm:portrait:w-full sm:portrait:max-w-[980px]"
        >
          <motion.img
            src={cafeExterior}
